...
`xcodebuild -workspace RealmTasks.xcworkspace -scheme "RealmTasks macOS" -derivedDataPath 'build' DEVELOPMENT_TEAM=QX5CR2FTN2 CODE_SIGN_IDENTITY='Developer ID Application' clean build -configuration Debug PROVISIONING_PROFILE=42568216-dcbb-4f07-b5ef-cda9ddfaa31e`
