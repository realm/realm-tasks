...
`xcodebuild -workspace RealmTasks.xcworkspace -scheme "RealmTasks macOS" -derivedDataPath 'build' CODE_SIGN_IDENTITY='Developer ID Application' clean build -configuration Debug`
