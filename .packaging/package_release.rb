...
output=`xcodebuild -workspace "RealmTasks Apple/RealmTasks.xcworkspace" -scheme "RealmTasks macOS" -derivedDataPath "build" DEVELOPMENT_TEAM=QX5CR2FTN2 CODE_SIGN_IDENTITY="Developer ID Application" PROVISIONING_PROFILE="" clean build`
p output
