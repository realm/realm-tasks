...
`xcodebuild -workspace "RealmTasks Apple/RealmTasks.xcworkspace" -scheme "RealmTasks macOS" -derivedDataPath 'build' DEVELOPMENT_TEAM=QX5CR2FTN2 -archivePath RealmTasks.xcarchive archive`
`xcodebuild -exportArchive -archivePath RealmTasks.xcarchive -exportPath RealmTasks.exported -exportOptionsPlist .packaging/archive-options.plist`
`mv RealmTasks.exported/RealmTasks.app .`
